...
const moment = require('moment-timezone'); // Utiliser moment-timezone
const app = express();

app.use(express.json());

app.post('/temps-restant', (req, res) => {
    const maintenant = moment().tz('Europe/Paris'); // Définit explicitement le fuseau horaire
    const finJournee = moment()
        .tz('Europe/Paris')
    ...
    const message = `La journée se termine dans ${heures} heure${
        heures > 1 ? 's' : ''
